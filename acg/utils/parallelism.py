...
def split_tensor_along_dim(
    ...
    assert dim_size % num_partitions == 0, \
...
class ParallelismManager:
    ...
    def __init__(
        ...
        self.pipeline_parallel_config = pipeline_parallel_config or PipelineParallelConfig()
        
        self.tensor_parallel_size = self.tensor_parallel_config.tensor_parallel_size
        self.pipeline_parallel_size = self.pipeline_parallel_config.pipeline_parallel_size
    ...
    def apply_tensor_parallelism(
        ...
        logger.info(f"Applying tensor parallelism with size={self.tensor_parallel_size}")
